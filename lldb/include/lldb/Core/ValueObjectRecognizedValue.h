//===-- ValueObjectRecognizedValue.h ----------------------------*- C++ -*-===//
//
...
#ifndef LLDB_CORE_VALUEOBJECTRECOGNIZEDVALUE_H
#define LLDB_CORE_VALUEOBJECTRECOGNIZEDVALUE_H
...
private:
  ...
  ValueObjectRecognizedValue(ValueObject &parent,
                             lldb::DynamicValueType use_dynamic);

  ValueObjectRecognizedValue(const ValueObjectRecognizedValue &) = delete;
  const ValueObjectRecognizedValue &
  operator=(const ValueObjectRecognizedValue &) = delete;
};

} // namespace lldb_private

#endif // LLDB_CORE_VALUEOBJECTRECOGNIZEDVALUE_H
